...
// Agregar esto al final de tu src/types/index.ts
...
//acaba cotizaciones
// Añadir esto a tu archivo de types
...
// src/types/index.ts (Añadir al final)
...
export interface DashboardData {
  ...
  gastoTotal: number;
  totalTickets: number;
  conteoSecciones: Record<string, number>;
  solicitudes: SolicitudHistorial[]; // Para el historial y tablas
}
//acaba dashboard historial general
